 ...
 *
 * @generated from compute/zlaswp.c, normal z -> d, Mon Feb  6 14:06:36 2017
 *
 **/
                  ...
                  double *pA, int lda, int *ipiv, int incx)
{
    ...
    #pragma omp master
    {
        ...
        #pragma omp taskwait
        plasma_omp_dlaswp(colrow, A, ipiv, incx, sequence, &request);
                       ...
                       plasma_sequence_t *sequence, plasma_request_t *request)
{
    ...
    plasma_pdlaswp(colrow, A, ipiv, incx, sequence, request);
}
