 ...
 *
 * @generated from compute/zlaswp.c, normal z -> c, Mon Feb  6 14:06:36 2017
 *
 **/
                  ...
                  plasma_complex32_t *pA, int lda, int *ipiv, int incx)
{
    ...
    #pragma omp master
    {
        ...
        #pragma omp taskwait
        plasma_omp_claswp(colrow, A, ipiv, incx, sequence, &request);
                       ...
                       plasma_sequence_t *sequence, plasma_request_t *request)
{
    ...
    plasma_pclaswp(colrow, A, ipiv, incx, sequence, request);
}
