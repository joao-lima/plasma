 ...
 *
 * @generated from test/test_zpotrf.c, normal z -> d, Mon Feb  6 14:07:13 2017
 *
 **/
#include "test.h"
#include "flops.h"
...
extern uint64_t _dpotrf_start;
extern uint64_t _dpotrf_stop;
...
void test_dpotrf(param_value_t param[], char *info)
{
    ...
    param[PARAM_START].t = _dpotrf_start;
    param[PARAM_STOP].t  = _dpotrf_stop;
