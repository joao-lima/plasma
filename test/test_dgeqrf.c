 ...
 *
 * @generated from test/test_zgeqrf.c, normal z -> d, Mon Feb  6 14:07:05 2017
 *
 **/
#include "test.h"
#include "flops.h"
...
extern uint64_t _dgeqrf_start;
extern uint64_t _dgeqrf_stop;
/***************************************************************************//**
 *
 * @brief Tests DGEQRF.
 *
...
void test_dgeqrf(param_value_t param[], char *info)
{
    ...
    param[PARAM_START].t = _dgeqrf_start;
    param[PARAM_STOP].t = _dgeqrf_stop;
