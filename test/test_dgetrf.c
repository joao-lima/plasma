 ...
 *
 * @generated from test/test_zgetrf.c, normal z -> d, Mon Feb  6 14:07:06 2017
 *
 **/
#include "test.h"
#include "flops.h"
...
extern double _dgetrf_start;
extern double _dgetrf_stop ;
...
void test_dgetrf(param_value_t param[], char *info)
{
    ...
    param[PARAM_START].d = _dgetrf_start;
    param[PARAM_STOP].d = _dgetrf_stop;
