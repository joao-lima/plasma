 ...
 *
 * @generated from core_blas/core_zgetrf.c, normal z -> c, Mon Feb  6 14:06:47 2017
 *
 **/
...
static int *max_idx;
static plasma_complex32_t *max_val;
                ...
                plasma_barrier_t *barrier)
{
    ...
    if (rank == 0) {
        ...
        max_val = (plasma_complex32_t*)malloc(size*sizeof(plasma_complex32_t));
        info = 0;
    }
